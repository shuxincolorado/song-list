...
import { Songs2Component } from './songs2.component';
...
let comp: Songs2Component;
let fixture: ComponentFixture<Songs2Component>;
let page: Page;

//Testing ///
describe('Songs2Component', () => {
  //let component: Songs2Component;
  //let fixture: ComponentFixture<Songs2Component>;
  ...
  it('should display songs', () => {
    console.log("inside Song2 unite test");
...
function createComponent() {
  fixture = TestBed.createComponent(Songs2Component);
